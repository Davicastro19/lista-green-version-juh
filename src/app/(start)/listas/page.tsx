...
function App() {
  ...
  const queryUrl = `/search/lists?${new URLSearchParams({
    ...
    <div className="min-h-screen">
      <div className="bg-white rounded-xl shadow-sm p-6 mb-0">
        <SearchForm
          ...
          type="lists"
        />
        <a className="flex mt-2 w-full justify-center items-center py-2 space-x-1.5 bg-gray-50 hover:bg-gray-100 my-0 cursor-pointer rounded-sm" href="/busca">
